...
func TestInsertPenbuk(t *testing.T) {
	t.Run("Success insert penerbit buku", func(t *testing.T) {
		penbukDummy := domain.Penerbit_Buku{
		...
		PenbukRepoInterfaceMock.On("CreatePenerbitBuku", mock.AnythingOfType("domain.Penerbit_Buku")).Return(penbukDummy, nil).Once()

		penbukInsert := domain.Penerbit_Buku{
			IDPenerbit:     "01H019WHW4A45KH65AH9XW89PC",
			PenerbitBuku:   "penerbit",
			AlamatPenerbit: "alamat penerbit",
			TelpPenerbit:   "031-031031",
...
func TestUpdateDataPenBuk(t *testing.T) {
	t.Run("Success update data", func(t *testing.T) {
		var DummyEdit domain.Penerbit_Buku
		PenbukRepoInterfaceMock.On("HitungDataPenerbitBuku", mock.Anything).Return(int64(1)).Once()
		PenbukRepoInterfaceMock.On("UpdatePenerbitBuku", mock.AnythingOfType("domain.Penerbit_Buku")).Return(domain.Penerbit_Buku{}, nil).Once()
		dataUpdate := domain.Penerbit_Buku{
			IDPenerbit:     "01H019WHW4A45KH65AH9XW89PC",
			PenerbitBuku:   "penerbit",
			AlamatPenerbit: "alamat penerbit",
