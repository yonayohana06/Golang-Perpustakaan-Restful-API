...
func (request *Jenis_Buku_Request) CreateJenisBuku() *domain.Jenis_Buku {
	var jenbukRequest domain.Jenis_Buku
...
func (request *Jenis_Buku_Request_Update) UpdateJenisBuku(idnya string) *domain.Jenis_Buku {
	var jenbukRequest domain.Jenis_Buku
