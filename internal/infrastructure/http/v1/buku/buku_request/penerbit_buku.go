...
func (request *Penerbit_Buku_Request) CreatePenerbitBuku() *domain.Penerbit_Buku {
	var penbukRequest domain.Penerbit_Buku
...
func (request *Penerbit_Buku_Request_Update) UpdatePenerbitBuku(idnya string) *domain.Penerbit_Buku {
	var penbukRequest domain.Penerbit_Buku
